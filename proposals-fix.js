(function(){
  ...
  document.write('<link rel="stylesheet" href="mayor-panel.css"><script src="mayor-panel.js"><\\/script><script src="mission-ui.js"><\\/script><script src="carousel-realistic.js"><\\/script>');
  ...
  const loadKiba=async()=>{
    ...
    await loadScript('kiba-presentation-replay.js?v=3','data-kiba-presentation-replay-loader');
    await loadScript('kiba-presentation-auto.js?v=3','data-kiba-presentation-auto-loader');
    await loadScript('kiba-presentation-polish.js?v=1','data-kiba-presentation-polish-loader');
