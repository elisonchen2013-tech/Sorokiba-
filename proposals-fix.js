(function(){
  ...
  const loadKiba=async()=>{
    ...
    await loadScript('kiba-presentation-replay.js?v=2','data-kiba-presentation-replay-loader');
    await loadScript('kiba-presentation-auto.js?v=2','data-kiba-presentation-auto-loader');
