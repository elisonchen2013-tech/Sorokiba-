...
function characterSvg(c){
 ...
 const scalpBase='<path d="M36 49C35 25 45 7 60 7C76 7 87 25 84 49C77 39 69 34 60 34C51 34 43 39 36 49Z" fill="url(#hair)"/>';
...
function showCharacterTab(tab){
 const map={face:'charFace',ears:'charEars',body:'charBody',hair:'charHair'};
