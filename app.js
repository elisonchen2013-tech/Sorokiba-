...
function characterSvg(c){
 ...
 const eyes={normal:'<g><ellipse cx="51" cy="52" rx="3.7" ry="4.2" fill="#172033"/><ellipse cx="69" cy="52" rx="3.7" ry="4.2" fill="#172033"/><circle cx="49.8" cy="50.6" r="1.15" fill="#fff"/><circle cx="67.8" cy="50.6" r="1.15" fill="#fff"/></g>',grande:'<g><ellipse cx="51" cy="52" rx="4.8" ry="5.5" fill="#172033"/><ellipse cx="69" cy="52" rx="4.8" ry="5.5" fill="#172033"/><circle cx="49.6" cy="50.2" r="1.3" fill="#fff"/><circle cx="67.6" cy="50.2" r="1.3" fill="#fff"/></g>',fechado:'<path d="M47 52Q51 48 55 52M65 52Q69 48 73 52" fill="none" stroke="#172033" stroke-width="2.4" stroke-linecap="round"/>'
 }[eye]||"";
 ...
 return '<svg viewBox="0 0 120 190" class="character-svg" aria-label="Personagem '+(female?"feminino":"masculino")+'"><defs><radialGradient id="skin" cx="35%" cy="24%" r="82%"><stop offset="0" stop-color="'+skin+'"/><stop offset=".58" stop-color="'+skin+'"/><stop offset="1" stop-color="#8a513d"/></radialGradient><linearGradient id="hair" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="'+hc+'"/><stop offset=".58" stop-color="'+hc+'"/><stop offset="1" stop-color="#17110f"/></linearGradient><linearGradient id="shirt" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="'+shirt+'"/><stop offset=".55" stop-color="'+shirt+'"/><stop offset="1" stop-color="#18224b"/></linearGradient><linearGradient id="pants" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="'+pants+'"/><stop offset="1" stop-color="#151a29"/></linearGradient></defs><g class="char-body"><path d="M43 69Q60 77 77 69L72 82Q60 88 48 82Z" fill="url(#skin)"/><path d="+facePath+" fill="url(#skin)" stroke="#704331" stroke-opacity=".22" stroke-width="1.2"/><path d="M40 52Q42 67 50 72" fill="none" stroke="#fff" stroke-opacity=".12" stroke-width="4" stroke-linecap="round"/><path d="M80 52Q78 67 70 72" fill="none" stroke="#5d3529" stroke-opacity=".18" stroke-width="4" stroke-linecap="round"/><ellipse cx="35.5" cy="53" rx="4" ry="5.5" fill="url(#skin)" stroke="#8a513d" stroke-opacity=".18"/><ellipse cx="84.5" cy="53" rx="4" ry="5.5" fill="url(#skin)" stroke="#8a513d" stroke-opacity=".18"/><path d="M54 73H66V82Q60 86 54 82Z" fill="url(#skin)"/>'+brows+eyes+noses+mouths+genderDetails+'<path d="M'+(60-b.shoulder)+' 80Q60 88 '+(60+b.shoulder)+' 80L'+(60+b.waist)+' 121Q60 127 '+(60-b.waist)+' 121Z" fill="url(#shirt)" stroke="#0c1324" stroke-width="1.2"/><path d="M'+(60-b.shoulder)+' 82Q60 91 '+(60+b.shoulder)+' 82" fill="none" stroke="#fff" stroke-opacity=".3" stroke-width="2"/>'+foldPaths+'<path d="M'+(60-b.shoulder)+' 84L'+(60-b.shoulder-b.arm)+' 101" stroke="url(#skin)" stroke-width="'+b.arm+'" stroke-linecap="round"/><path d="M'+(60+b.shoulder)+' 84L'+(60+b.shoulder+b.arm)+' 101" stroke="url(#skin)" stroke-width="'+b.arm+'" stroke-linecap="round"/><circle cx="'+(60-b.shoulder-b.arm)+'" cy="101" r="'+(b.arm/2+2)+'" fill="url(#skin)"/><circle cx="'+(60+b.shoulder+b.arm)+'" cy="101" r="'+(b.arm/2+2)+'" fill="url(#skin)"/><path d="M'+(60-b.waist)+' 120L'+(60+b.waist)+' 120L'+(60+16)+' 158Q60 164 '+(60-16)+' 158Z" fill="url(#pants)" stroke="#0b1020" stroke-width="1.2"/><path d="M60 124V158" stroke="#fff" stroke-opacity=".16" stroke-width="2"/><path d="M44 156H59V172H35Q35 160 44 156ZM61 156H76Q85 160 85 172H61Z" fill="'+shoes+'" stroke="#0b0f15" stroke-width="1.2"/><path d="M35 168H59M61 168H85" stroke="#fff" stroke-opacity=".28" stroke-width="2.4" stroke-linecap="round"/>'+hairMap+'</g>'+acc+held+'</svg>';
}
...
async function accountPage(box){
 ...
 const hairStyles=['curto','medio','longo','cacheado','crespo','coque','raspado','moicano'];
