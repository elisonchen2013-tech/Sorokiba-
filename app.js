...
function characterSvg(c){
 ...
 const shapes={magro:{shoulder:18,waist:17,arm:6},normal:{shoulder:22,waist:20,arm:7},forte:{shoulder:26,waist:23,arm:8}},b=shapes[body]||shapes.normal;
 const hairMap={
...
async function accountPage(box){
 ...
 const hairButtons=hairStyles.map(h=>'<button class="hair-choice '+(c.hairStyle===h?'selected':'')+'" data-choice-key="hairStyle" data-choice-value="'+h+'" onclick="setCharacterField(\''+h+'\')">'+h[0].toUpperCase()+h.slice(1)+'</button>').join('');
 ...
 box.innerHTML='<div class="character-profile">'+
  ...
  '<div class="character-editor">'+
   ...
   '<div id="charFace" class="char-panel"><div class="choice-title">Gênero</div><div class="choice-row">'+
    ...
    '<button class="choice-btn" data-choice-key="eyeStyle" data-choice-value="normal" onclick="setCharacterField(\'eyeStyle\',\'normal\')">Normais</button><button class="choice-btn" data-choice-key="eyeStyle" data-choice-value="grande" onclick="setCharacterField(\'eyeStyle\',\'grande\')">Grandes</button><button class="choice-btn" data-choice-key="eyeStyle" data-choice-value="fechado" onclick="setCharacterField(\'eyeStyle\',\'fechado\')">Fechados</button></div>'+
    '<div class="choice-title">Sobrancelhas</div><div class="choice-row"><button class="choice-btn" data-choice-key="browStyle" data-choice-value="normal" onclick="setCharacterField(\'browStyle\',\'normal\')">Normais</button><button class="choice-btn" data-choice-key="browStyle" data-choice-value="reto" onclick="setCharacterField(\'browStyle\',\'reto\')">Retas</button><button class="choice-btn" data-choice-key="browStyle" data-choice-value="arqueada" onclick="setCharacterField(\'browStyle\',\'arqueada\')">Arqueadas</button><button class="choice-btn" data-choice-key="browStyle" data-choice-value="forte" onclick="setCharacterField(\'browStyle\',\'forte\')">Fortes</button><button class="choice-btn" data-choice-key="browStyle" data-choice-value="preocupada" onclick="setCharacterField(\'browStyle\',\'preocupada\')">Preocupadas</button></div>'+
    '<div class="choice-title">Nariz</div><div class="choice-row"><button class="choice-btn" data-choice-key="noseStyle" data-choice-value="normal" onclick="setCharacterField(\'noseStyle\',\'normal\')">Normal</button><button class="choice-btn" data-choice-key="noseStyle" data-choice-value="fino" onclick="setCharacterField(\'noseStyle\',\'fino\')">Fino</button><button class="choice-btn" data-choice-key="noseStyle" data-choice-value="arredondado" onclick="setCharacterField(\'noseStyle\',\'arredondado\')">Arredondado</button><button class="choice-btn" data-choice-key="noseStyle" data-choice-value="arrebitado" onclick="setCharacterField(\'noseStyle\',\'arrebitado\')">Arrebitado</button></div>'+
    '<div class="choice-title">Boca / expressão</div><div class="choice-row"><button class="choice-btn" data-choice-key="mouthStyle" data-choice-value="normal" onclick="setCharacterField(\'mouthStyle\',\'normal\')">Normal</button><button class="choice-btn" data-choice-key="mouthStyle" data-choice-value="sorriso" onclick="setCharacterField(\'mouthStyle\',\'sorriso\')">Sorriso</button><button class="choice-btn" data-choice-key="mouthStyle" data-choice-value="serio" onclick="setCharacterField(\'mouthStyle\',\'serio\')">Sério</button><button class="choice-btn" data-choice-key="mouthStyle" data-choice-value="aberta" onclick="setCharacterField(\'mouthStyle\',\'aberta\')">Aberta</button><button class="choice-btn" data-choice-key="mouthStyle" data-choice-value="surpreso" onclick="setCharacterField(\'mouthStyle\',\'surpreso\')">Surpreso</button><button class="choice-btn" data-choice-key="mouthStyle" data-choice-value="triste" onclick="setCharacterField(\'mouthStyle\',\'triste\')">Triste</button></div></div></div>'+
   '<div id="charBody" class="char-panel hidden"><div class="choice-title">Tipo de corpo</div><div class="choice-row"><button class="choice-btn" data-choice-key="bodyType" data-choice-value="magro" onclick="setCharacterField(\'bodyType\',\'magro\')">Magro</button><button class="choice-btn" data-choice-key="bodyType" data-choice-value="normal" onclick="setCharacterField(\'bodyType\',\'normal\')">Normal</button><button class="choice-btn" data-choice-key="bodyType" data-choice-value="forte" onclick="setCharacterField(\'bodyType\',\'forte\')">Forte</button></div><div class="choice-title">Tom de pele</div><div class="quick-palette">'+skinDots+'</div><div class="color-grid"><label>Pele<input id="charSkin" type="color" value="'+(c.skin||'#f1c27d')+'" oninput="setCharacterField(\'skin\',this.value)"></label></div></div>'+
