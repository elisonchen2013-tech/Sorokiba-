...
async function homeCarousel(box){
  ...
  if(!document.getElementById('sorokiba-city-carousel-styles')){
    ...
    style.textContent=[
      ...
      '.soro-home-carousel .sc-butterfly{font-size:0;width:28px;height:20px;animation:scButterfly 7s ease-in-out infinite}.soro-home-carousel .sc-butterfly:before,.soro-home-carousel .sc-butterfly:after{content:"";position:absolute;top:1px;width:13px;height:17px;border-radius:80% 20% 70% 30%;background:#f7a9c4;box-shadow:inset 2px 0 rgba(255,255,255,.5)}.soro-home-carousel .sc-butterfly:before{left:0;transform:rotate(-25deg)}.soro-home-carousel .sc-butterfly:after{right:0;transform:scaleX(-1) rotate(-25deg)}',
  ...
  const jobDecorations={estudante:['sc-job-student','📚','Sala de estudos'],entregador:['sc-job-delivery','📦','Central de entregas'],comerciante:['sc-job-shop','🛍️','Comércio local'],motorista:['sc-job-driver','🚕','Avenida de Sorokiba'],policial:['sc-job-police','🚓','Patrulha da cidade'],enfermeiro:['sc-job-nurse','🏥','Enfermagem'],medico:['sc-job-doctor','🩺','Clínica médica'],programador:['sc-job-programmer','💻','Centro de tecnologia'],engenheiro:['sc-job-engineer','🏗️','Obras e engenharia']};
  const jd=jobDecorations[String(currentJob?.id||me?.jobId||'')]||['sc-job-default','💼','Vida profissional'];
