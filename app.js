...
function characterSvg(c){
 ...
 const hairMap={
 curto:'<path d="M35 49C34 27 46 12 60 12C76 12 87 27 85 50C78 40 70 35 60 35C50 35 42 40 35 49Z" fill="url(#hair)"/><path d="M39 31Q49 16 60 16Q72 16 81 31" fill="none" stroke="#fff" stroke-opacity=".22" stroke-width="2"/><path d="M43 25Q60 12 77 25" fill="none" stroke="#fff" stroke-opacity=".12" stroke-width="3"/>',
 medio:'<path d="M34 54C32 27 45 11 60 11C77 11 89 27 86 55L80 77L72 51C69 40 65 36 60 36C55 36 50 40 47 51L40 77Z" fill="url(#hair)"/><path d="M40 55Q42 68 40 76M80 55Q78 68 80 76" fill="none" stroke="#fff" stroke-opacity=".16" stroke-width="2.5"/>',
 longo:'<path d="M33 55C31 26 44 9 60 9C78 9 90 27 87 57L84 103L72 98L69 52C66 40 64 35 60 35C55 35 51 41 48 53L45 99L33 103Z" fill="url(#hair)"/><path d="M37 57Q41 88 39 100M83 57Q79 89 81 100" fill="none" stroke="#fff" stroke-opacity=".18" stroke-width="3"/>',
 cacheado:'<g fill="url(#hair)"><circle cx="39" cy="39" r="10"/><circle cx="47" cy="26" r="11"/><circle cx="59" cy="22" r="13"/><circle cx="72" cy="26" r="11"/><circle cx="81" cy="40" r="10"/><circle cx="43" cy="50" r="10"/><circle cx="77" cy="50" r="10"/><circle cx="50" cy="36" r="9"/><circle cx="69" cy="36" r="9"/></g><path d="M42 29Q57 16 73 28" fill="none" stroke="#fff" stroke-opacity=".15" stroke-width="3"/>',
 ...
 coque:'<circle cx="76" cy="13" r="12" fill="url(#hair)"/><path d="M36 50C35 27 47 13 60 13C74 13 85 27 84 50C77 40 69 35 60 35C51 35 43 40 36 50Z" fill="url(#hair)"/><path d="M43 27Q60 16 77 27" fill="none" stroke="#fff" stroke-opacity=".18" stroke-width="2"/>',
 raspado:'<path d="M38 43C38 24 48 14 60 14C72 14 82 24 82 43Q74 34 60 34Q46 34 38 43Z" fill="url(#hair)"/><path d="M43 25Q60 16 77 25" fill="none" stroke="#fff" stroke-opacity=".22" stroke-width="2"/>',
 moicano:'<path d="M47 40L52 9L58 22L63 5L68 22L75 10L76 40Q69 34 60 34Q51 34 47 40Z" fill="url(#hair)"/><path d="M55 18L60 9L65 19" fill="none" stroke="#fff" stroke-opacity=".2" stroke-width="2"/>'
 }[hair]||"";
 const eyes={normal:'<g><ellipse cx="51" cy="51" rx="3.2" ry="3.6" fill="#172033"/><ellipse cx="69" cy="51" rx="3.2" ry="3.6" fill="#172033"/><circle cx="50.2" cy="50" r="1" fill="#fff"/><circle cx="68.2" cy="50" r="1" fill="#fff"/></g>',grande:'<g><ellipse cx="51" cy="51" rx="4.6" ry="5.2" fill="#172033"/><ellipse cx="69" cy="51" rx="4.6" ry="5.2" fill="#172033"/><circle cx="50" cy="49.5" r="1.2" fill="#fff"/><circle cx="68" cy="49.5" r="1.2" fill="#fff"/></g>',fechado:'<path d="M47 52Q51 48 55 52M65 52Q69 48 73 52" fill="none" stroke="#172033" stroke-width="2.2" stroke-linecap="round"/>'
 }[eye]||"";
 const brows={normal:'<path d="M47 44Q51 42 55 44M65 44Q69 42 73 44" fill="none" stroke="#3b281f" stroke-width="2" stroke-linecap="round"/>',reto:'<path d="M47 43H55M65 43H73" fill="none" stroke="#3b281f" stroke-width="2.3" stroke-linecap="round"/>',arqueada:'<path d="M47 45Q51 39 55 44M65 44Q69 39 73 45" fill="none" stroke="#3b281f" stroke-width="2.3" stroke-linecap="round"/>',forte:'<path d="M46 44Q51 39 56 43M64 43Q69 39 74 44" fill="none" stroke="#3b281f" stroke-width="3.2" stroke-linecap="round"/>',preocupada:'<path d="M47 46Q51 41 55 44M65 44Q69 41 73 46" fill="none" stroke="#3b281f" stroke-width="2.4" stroke-linecap="round"/>'
 }[brow]||"";
 const mouths={normal:'<path d="M57 65Q60 67 63 65" fill="none" stroke="#8c493e" stroke-width="1.7" stroke-linecap="round"/>',sorriso:'<path d="M54 64Q60 72 66 64Q60 68 54 64Z" fill="#8c493e"/><path d="M56 65Q60 67 64 65" fill="none" stroke="#fff" stroke-width="1.2"/>',serio:'<path d="M55 66H65" fill="none" stroke="#8c493e" stroke-width="2" stroke-linecap="round"/>',aberta:'<ellipse cx="60" cy="66" rx="5" ry="3.7" fill="#713c39"/><path d="M57 65H63" stroke="#fff" stroke-width="1"/>',surpreso:'<ellipse cx="60" cy="66" rx="3.6" ry="4.8" fill="#713c39"/><ellipse cx="60" cy="65" rx="1.5" ry="1" fill="#fff"/>',triste:'<path d="M55 68Q60 64 65 68" fill="none" stroke="#8c493e" stroke-width="2" stroke-linecap="round"/>'
 }[mouth]||"";
 const noses={normal:'<path d="M60 53L58 60L61 60" fill="none" stroke="#9a5548" stroke-width="1.2" stroke-linecap="round"/>',fino:'<path d="M60 53L59 60L61 60" fill="none" stroke="#9a5548" stroke-width="1" stroke-linecap="round"/>',arredondado:'<path d="M60 53L57 60Q60 63 63 60" fill="none" stroke="#9a5548" stroke-width="1.2" stroke-linecap="round"/>',arrebitado:'<path d="M60 53L58 60Q60 58 62 60" fill="none" stroke="#9a5548" stroke-width="1.2" stroke-linecap="round"/>'
 }[nose]||"";
 const folds=body==="magro"?2:body==="forte"?4:3;
 const foldPaths=Array.from({length:folds},(_,i)=>'<path d="M'+(46+i*8)+' 91Q60 '+(95+i%2*3)+' '+(74-i*8)+' 91" fill="none" stroke="#fff3" stroke-width="1.4"/>').join("");
 ...
 const positions=[{x:60,y:18,rot:0},{x:60,y:89,rot:0},{x:88,y:108,rot:-8},{x:91,y:76,rot:8}];
 const acc=equipped.map((a,i)=>{const p=positions[i];const emoji=esc(a.emoji||"🎒");return '<g class="char-item" transform="translate('+p.x+' '+p.y+') rotate('+p.rot+')"><circle r="13" fill="rgba(10,16,30,.82)" stroke="#fff" stroke-opacity=".3"/><text text-anchor="middle" dominant-baseline="central" font-size="13">'+emoji+'</text></g>'}).join("");
 const held=x.held?'<g class="char-held"><rect x="87" y="101" width="13" height="22" rx="3"/><circle cx="93.5" cy="98" r="4"/></g>':"";
 return '<svg viewBox="0 0 120 190" class="character-svg" aria-label="Personagem '+(female?"feminino":"masculino")+'"><defs><radialGradient id="skin" cx="35%" cy="25%" r="80%"><stop offset="0" stop-color="#fff5"/><stop offset=".18" stop-color="'+skin+'"/><stop offset=".7" stop-color="'+skin+'"/><stop offset="1" stop-color="#8b4f3a55"/></radialGradient><linearGradient id="hair" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="'+hc+'"/><stop offset=".55" stop-color="'+hc+'"/><stop offset="1" stop-color="#00000080"/></linearGradient><linearGradient id="shirt" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="'+shirt+'"/><stop offset="1" stop-color="#00000038"/></linearGradient><linearGradient id="pants" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="'+pants+'"/><stop offset="1" stop-color="#00000038"/></linearGradient></defs><g class="char-body"><path d="M43 69Q60 78 77 69L73 82Q60 87 47 82Z" fill="url(#skin)"/><ellipse cx="60" cy="48" rx="24" ry="27" fill="url(#skin)" stroke="#00000018"/><path d="M41 45Q35 57 43 68" fill="#0002"/><path d="M79 45Q85 57 77 68" fill="#0002"/><ellipse cx="36.5" cy="53" rx="3.5" ry="5" fill="url(#skin)"/><ellipse cx="83.5" cy="53" rx="3.5" ry="5" fill="url(#skin)"/><path d="M53 67H67V80H53Z" fill="url(#skin)"/><path d="M'+(60-sh)+' 78L'+(36-sh/2)+' 96L'+(40-sh/2)+' 100L51 85M'+(60+sh)+' 78L'+(84+sh/2)+' 96L'+(80+sh/2)+' 100L69 85" fill="url(#skin)" stroke="#0002"/><circle cx="'+(36-sh/2)+'" cy="97" r="5" fill="url(#skin)"/><circle cx="'+(84+sh/2)+'" cy="97" r="5" fill="url(#skin)"/><path d="M60 73L'+(r+6)+' 84L'+r+' 120Q60 126 '+l+' 120L'+(l-6)+' 84Z" fill="url(#shirt)" stroke="#0003"/><path d="M'+l+' 84Q60 91 '+r+' 84" fill="none" stroke="#fff5" stroke-width="2"/>'+foldPaths+'<path d="M'+l+' 118Q60 124 '+r+' 118L80 157Q60 164 40 157Z" fill="url(#pants)" stroke="#0003"/><path d="M60 123V155" stroke="#fff3" stroke-width="1.5"/><path d="M40 154H59V171H35Q35 159 40 154ZM61 154H80Q85 159 85 171H61Z" fill="'+shoes+'" stroke="#0005"/><path d="M35 168H59M61 168H85" stroke="#fff3" stroke-width="2"/>'+brows+eyes+noses+mouths+(female?'<path d="M48 76Q60 72 72 76" fill="none" stroke="#fff2" stroke-width="2"/>':"")+hairMap+'</g>'+acc+held+'</svg>';
}
