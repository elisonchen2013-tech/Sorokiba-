...
function vehicleFieldsForForm(f){
 const type=f.type?.value;
 const old=f.querySelector(".vehicle-customizer");
 if(type==="veiculo"&&!old){const wrap=document.createElement("div");wrap.innerHTML=vehicleCustomizationFields();f.appendChild(wrap.firstElementChild)}
 if(type!=="veiculo"&&old)old.remove();
}
